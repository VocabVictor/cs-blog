  ...
  class FixIt {
    ...
    initTypeit() {
      ...
      if (this.config.typeit) {
        ...
        const duration = typeitConfig.duration || 1000;
        const deleteSpeed = typeitConfig.deleteSpeed || 50;
        const loop = typeitConfig.loop || true;
        const waitUntilVisible = typeitConfig.waitUntilVisible || true;
        const lifeLike = typeitConfig.lifeLike || true;
